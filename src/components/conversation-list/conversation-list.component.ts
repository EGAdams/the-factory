import html from './conversation-list.html';
import style from './styles/main.css';
import { Component } from "@/utils";

@Component({ html: html, style: style, properties: []})
export class ConversationList implements IWebComponent {
     ...
     */
    connectedCallback() {
        console.log( 'conversation-list connected' );
    }

    /** Invoked each time the custom element is disconnected from the document's DOM. */
    disconnectedCallback() { console.log( 'conversation-list disconnected' ); }
    adoptedCallback() {      console.log( 'conversation-list moved'        ); }
