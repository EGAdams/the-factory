import html from './inner-component.html';
import style from './styles/main.css';
import { Component } from "@/utils";

@Component({ html: html, style: style, properties: []})
export class InnerComponent implements IWebComponent {
     ...
     */
    connectedCallback() {
        console.log( 'inner-component connected' );
    }

    /** Invoked each time the custom element is disconnected from the document's DOM. */
    disconnectedCallback() { console.log( 'inner-component disconnected' ); }
    adoptedCallback() {      console.log( 'inner-component moved'        ); }
